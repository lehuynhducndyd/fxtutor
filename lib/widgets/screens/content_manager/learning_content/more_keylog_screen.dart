...
class MoreKeylogScreen extends StatefulWidget {
  static const String route = 'MoreKeylogScreen';

  const MoreKeylogScreen({super.key});

  @override
  State<MoreKeylogScreen> createState() => _MoreKeylogScreenState();
}

class _MoreKeylogScreenState extends State<MoreKeylogScreen> {
  ...
  Future<Map<String, String>> _loadMappingData() async {
    final String response = await rootBundle.loadString('assets/keymap/other880.json');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Casio fx-880BTG Keylog', style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
        elevation: 0,
      ),
      body: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  // Ký tự nút bấm máy tính (Font Casio)
                                  Expanded(
                                    child: Center(
                                      child: RichText(
